        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-slate-600 max-w-3xl mx-auto leading-relaxed mb-8">
              Build trust in your delivery operations with condition-based
              escrow. Verify deliveries, document package condition, and
              automate payments.
            </p>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-4xl font-bold text-slate-900 mb-6">
              Transform your{" "}
              <span className="text-green-600">delivery operations</span>
            </h2>
          </motion.div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-slate-600 max-w-2xl mx-auto">
              See how logistics companies use escrow to improve delivery
